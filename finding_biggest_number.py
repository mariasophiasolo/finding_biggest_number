...
find_button.place (x=105,y=460)

result_label = tk.Label(window, text="The Biggest Number:", font=("Glacial Indifference", 10, "bold"), fg="khaki1", bg="black",)
result_label.place(x=104, y=420)
